...
function Profile() {
    ...
    const fetchUserData = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                setUserData(response.data.data); // ✅ Load profile data from backend
            }
        } catch (error) {
  ...
  const handleSave = async () => {
    ...
    // If a profile image is selected, add it to FormData
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.profileImageContainer}>
        <img src={`${process.env.REACT_APP_BASE_URL}${userData.profileImage}` } alt="" className={styles.profileImage} />
